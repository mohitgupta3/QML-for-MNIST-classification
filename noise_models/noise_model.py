...
if __name__ == '__main__':
	...
	plt.legend()
	plt.title(
		'%s trials of 10 Qubit GHZ states $\langle S_z \\rangle$, with QVM noise model' % num_trials
	)
	plt.xlabel('$\langle S_z \\rangle$')
	plt.ylabel('#')
	plt.xlim((-10, 10))
	plt.savefig('../figures/NoiseModelPauliChannel_10_qubit_GHZ_state_1000_Trial_Measurements.png', dpi = 450)
